#!/usr/bin/env python3
"""
Backtest Signals - Historical testing of momentum signals
=========================================================
Fetches historical data and simulates signal detection and outcomes.
...
def run_backtest(symbols: List[str] = None, days: int = 90,
    ...
    print("="*60)
    print("BACKTEST - MOMENTUM SIGNALS")
    print("="*60)
...
def main():
    ...
    if args.output:
        ...
        output_file = os.path.join(SCRIPT_DIR, "backtest_results.json")
